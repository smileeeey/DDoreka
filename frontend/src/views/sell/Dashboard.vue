  ...
  <v-container fluid style="width: 75%;">
      ...
      <v-col cols="6" md="3">
        <v-card>
          <v-list-item>
            <v-list-item-content>
              <strong>오늘 매출</strong>
              <span style="text-align: right; color: red;" v-if="todayDate > -1 == true"
                >+ {{ (linedata.datasets[0].data[todayDate] - linedata.datasets[0].data[todayDate - 1]) | comma }} 원</span
              >
    ...
    <v-row style="my-5" @click="componentKey += 1">
      ...
      <v-col cols="12" md="4" offset-md="2">
        <LineChart :key="componentKey" :chartdata="linedata" />
      </v-col>
    </v-row>
