  ...
  <v-stepper v-model="e1">
    <v-col class="px-5" cols="8" offset="2">
      <v-stepper-header>
        ...
        <v-stepper-step step="4"> 최종 등록 </v-stepper-step>
      </v-stepper-header>
    </v-col>
    ...
    <v-stepper-items>
      ...
      <v-stepper-content step="2">
        <RegisterProductInfo
          ...
          @productname="(val) => (productname = val)"
        />
        <v-col cols="12" class="text-right">
          <div>
            <v-btn
            ...
            <v-btn color="primary" @click="e1 = 3" style="margin-right: 2rem">
              다음
            </v-btn>
          </div>
        </v-col>
      ...
      <v-stepper-content step="3">
        <RegisterProductImage
          @simage="(val) => (simages = val)"
          @mimage="(val) => (mimages = val)"
        />
        ...
        <v-col cols="12" class="text-right">
          <div>
            ...
            <v-btn color="primary" @click="e1 = 4" style="margin-right: 2rem">
              다음
            </v-btn>
          </div>
        </v-col>
...
export default {
  ...
  methods: {
    registerItem() {
      ...
      axios
        .post("http://k4d104.p.ssafy.io:8082/file/upload", formData, {
          headers: {
