  ...
  methods: {
    ...
    signup() {
      if (document.location.href.split('sell').length > 1) {
        ...
        axios.post(`http://k4d104.p.ssafy.io:8088/seller/add`, {
          name: this.form.name,
          ...
          .then(res => {
            ...
            if (res.status == 200) {
              axios.post(`http://k4d104.p.ssafy.io:8088/login/add`, {
        ...
        axios.post(`http://k4d104.p.ssafy.io:8085/user/signup`, this.form)
          .then(res => {
