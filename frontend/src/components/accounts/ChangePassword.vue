  ...
  <div>
    <v-container fluid>
      <v-row>
        ...
        <v-col cols="5">
          <v-text-field solo flat dense outlined required validate-on-blur type="password" v-model="form.password"></v-text-field>
        </v-col>
      </v-row>
      ...
      <v-row>
        ...
        <v-col cols="5">
          <v-text-field solo flat dense outlined required :rules="[required, min_pw]" v-model="form.newpassword" type="password"></v-text-field>
        </v-col>
      </v-row>
      ...
      <v-row>
        ...
        <v-col cols="5">
          <v-text-field solo flat dense outlined required :rules="[passwordConfirmationRule]" v-model="rePassword" type="password"></v-text-field>
        </v-col>
      </v-row>
      <v-row>
        <v-col offset="2" cols="2">
          <v-btn :disabled="!enable" @click="changepassword">비밀번호 변경</v-btn>
        </v-col>
      </v-row>
    </v-container>
  </div>
