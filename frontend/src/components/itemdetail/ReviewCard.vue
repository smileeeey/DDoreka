...
export default {
  ...
  methods: {
    ...
    getFiles() {
      axios.get(`http://k4d104.p.ssafy.io:8082/file/fileServe`, {
        params: {
    ...
    changeLike() {
      if (this.heartState === 'mdi-heart-outline') {
        ...
        axios.post('http://k4d104.p.ssafy.io:8083/review/like', {
        ...
        axios.delete(`http://k4d104.p.ssafy.io:8083/review/dislike/${this.review.id}/${this.userId}`)
        .then(res => {
          console.log(res)
          this.reviewlikeCnt--
        })
