<template>
  <div style="height: 115px;">
    ...
    <div
      ...
      v-show="CategoriesShow"
      @mouseleave="
        CategoriesShow = false;
        SubShow = false;
      "
    >
      <div class="mx-auto box" style="position: absolute; top: 0px; width: 150px; height: 492px; background-color: white;">
        <div>
          <ul
        ...
        <div
          class="box"
          style="position: absolute; top: -1px; left: 148px; width: 400px; height: 492px; background-color: white;"
          v-show="SubShow"
          @mouseleave="
            SubShow = false;
            selectedSubitem = -1;
        ...
        >
          <div v-if="selectedItem > -1">
            <div
              v-for="(subitem, idx) in items[selectedItem].subCategory"
              :key="idx"
              @mouseover="
                selectedSubitem = idx;
                ContentShow = true;
            ...
            <div class="box" v-if="selectedSubitem > -1" style="position: absolute; top: -1px; left: 148px; width: 251px; height: 492px;">
              <div
                v-for="(content, idx) in items[selectedItem].subCategory[selectedSubitem].subCategory"
                :key="idx"
                @mouseover="selectedContent = idx"
              >
                <ul
                  @click="
                    $router.push({ name: 'Category', params: { id: content.id, depth: 3 } });
                    CategoriesShow = false;
                  "
                  style="padding-left: 0px;"
                  class="my-2"
