...
export default {
  ...
  created() {
    axios.get(`http://k4d104.p.ssafy.io:8084/order/userid/${this.userId}/status/0`)
      .then(res => {
        this.prepareCnt = res.data.data.length
      })
    axios.get(`http://k4d104.p.ssafy.io:8084/order/userid/${this.userId}/status/1`)
      .then(res => {
        this.deliveryCnt = res.data.data.length
      })
    axios.get(`http://k4d104.p.ssafy.io:8084/order/userid/${this.userId}/status/2`)
      .then(res => {
