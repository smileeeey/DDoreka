...
import com.eureka.auth.account.AccountService;
import com.eureka.auth.jwt.JwtTokenVerifier;
import com.eureka.auth.jwt.JwtUsernameAndPasswordAuthenticationFilter;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public ApplicationSecurityConfig(PasswordEncoder passwordEncoder, AccountService accountService){
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/login/email-check").permitAll()
